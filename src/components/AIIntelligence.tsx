    ...
    <section className="bg-white py-16 font-bricolage" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Ziggy's AI intelligence works as an <span className="text-[#922ea4]">extension of you or your team,</span> learning from your workflow and materials to respond, organize, and retrieve what matters. Your leads, data, and documents <span className="text-[#922ea4]">become smarter,</span> helping you close more deals and build a <span className="text-[#922ea4]">powerhouse real estate brand.</span>
          </motion.p>
