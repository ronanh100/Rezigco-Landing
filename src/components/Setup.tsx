          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 md:order-1">
              <p className="text-xl md:text-2xl text-black font-medium">
                <span className="text-[#922ea4]">For teams and individual agents,</span> your AI agent works seamlessly with your existing tools and is ready to set up in minutes.
              </p>
            </div>
